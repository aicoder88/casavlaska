...
export default function LiveViewers() {
  ...
  useEffect(() => {
    ...
    }, 10000 + Math.random() * 20000) // Start checking after 10-30 seconds
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="glass-card px-4 py-2 rounded-full border border-white/20 bg-white/10 backdrop-blur-md shadow-lg">
